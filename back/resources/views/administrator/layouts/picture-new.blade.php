...
<div class="box">
      ...
      <div class="box">
        <form class="form" action="@if($type=='new'){{ route('admin-pictures-add') }}@else{{ route('admin-pictures-update' , ['picture'=> $item->id]) }}@endif" method="post" enctype="multipart/form-data">
            @csrf
